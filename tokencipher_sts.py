...
def start_point(decoder_key, token_block):
    ...
    # complimented_key = ones_complement(int(decoder_key, base=2))
    # rotated_key = rotr(complimented_key, 12)

    start_point_int = int(decoder_key, base=2) ^ int(token_block, base=2)


        
    # decoder_key_1s_compliment = 
...
def token_nibbleate(bits66_string):
    decimal_token = int(bits66_string, base=2)
    ...
    return concatenated_decimal_nibbles, padded_decimal_token
